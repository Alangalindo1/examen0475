...
class Pantalla2_0475 extends StatefulWidget {
  const Pantalla2_0475({super.key});

  @override
  Pantalla2_0475State createState() => Pantalla2_0475State();
}

class Pantalla2_0475State extends State<Pantalla2_0475> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Paguina 2 examen_0475"),
