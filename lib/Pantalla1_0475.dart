...
class Pantalla1_0475 extends StatefulWidget {
  const Pantalla1_0475({Key? key}) : super(key: key);

  @override
  Pantalla1_0475State createState() => Pantalla1_0475State();
}

class Pantalla1_0475State extends State<Pantalla1_0475> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Paguina 1 examen_0475"),
          backgroundColor: Color(0xff094c84),
        ),
        body: Center(
          child: Card(
